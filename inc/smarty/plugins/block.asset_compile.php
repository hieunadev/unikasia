...
define("ASSET_COMPILE_OUTPUT_DIR", $_SERVER['DOCUMENT_ROOT'].dirname($_SERVER['SCRIPT_NAME']).'/pcache/asset_compile');
define("ASSET_COMPILE_URL_ROOT", $_SERVER['DOCUMENT_ROOT'].dirname($_SERVER['SCRIPT_NAME']).'/assetcache');
//define("DEBUG", true);
