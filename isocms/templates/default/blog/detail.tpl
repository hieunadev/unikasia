        ...
        <div class="row">
            <div class="col-md-6">
                <div class="img_blogdetail">
                    <img src="{$imgBlog}" alt="img_blog" class="img-fluid img_detailblog">
                </div>
            </div>
            <div class="col-md-6">
                <div class="rounded_right">
                    <div class="textdesblog">
                        ...
                        <p class="txt_blogdetaildes">If you are traveling throughout the North and are looking for a
                            ...
                            opportunity to enjoy unique and delicious local cuisine, then don't hesitate to come to
                            Hanoi and experience the top best things to do in Hanoi for 3 days.</p>
                        <div class="infor_dateauthor">
                            <div class="infor_date">
                                <i class="fa-regular fa-clock-three" style="color: #ffffff;"></i>
                                <span>{$publish_date}</span>
                            </div>
                            <div class="infor_author">
                                <i class="fa-solid fa-user" style="color: #ffffff;"></i> <span>{$author}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="breadcrumb">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{PCMS_URL}blog/vietnam" title="{$core->get_Lang('Vietnam')}">Vietnam</a>
                    </li>
...
{*                            <p class="txt_p_detailblog">Hanoi, the capital of Vietnam, is a vibrant metropolis of 8*}
{*                                million*}
{*                                people, combining rich cultural heritage with the hustle and bustle of modern life. “Ha”*}
{*                                is*}
{*                                a river, “Noi” is inland, and Hanoi means “inland between rivers”. Bordered by the Red*}
{*                                River*}
{*                                in the north of the country, Hanoi is famous for its historical charm, characterized by*}
{*                                ancient temples, colonial architecture, and the labyrinthine streets of the old quarter.*}
{*                                Visitors to Hanoi cannot miss famous landscapes such as exploring places such as Hoan*}
{*                                Kiem*}
{*                                Lake, Ho Chi Minh Mausoleum, One Pillar Pagoda, Temple of Literature,... Hanoi is also*}
{*                                self-sufficient. </p>*}
{*                            <p class="txt_p_detailblog">Proud to be a culinary paradise with a strongly developed street*}
{*                                food scene, offering many delicious dishes. With a unique blend of tradition and*}
{*                                progress,*}
{*                                Hanoi continues to be an attractive destination for tourists looking for the flavors of*}
{*                                Vietnam past and present. In this guide, Autour Asia will introduce the top things to do*}
{*                                in*}
{*                                Hanoi for 3 days.</p>*}
{*                            <div class="img-blogdetail">*}
{*                                <img class="img_blogdetail" src="{URL_IMAGES}/blog/img_detailblog1.png" alt="imgdetail"*}
{*                                     title="imgdetail" width="908" height="605">*}
{*                            </div>*}
{*                        </div>*}

{*                        <div class="introduct_txt">*}
{*                            <h2 class="title-detailblog">The best time to visit Hanoi</h2>*}
{*                            <p class="txt_p_detailblog">The best time to visit Hanoi is generally between the months of*}
{*                                September and November, as well as between March and April. During these periods, the*}
{*                                climate is generally more pleasant, with moderate temperatures and relatively low*}
{*                                humidity.*}
{*                                From September to November, you can enjoy mild temperatures, pleasant sunshine, and a*}
{*                                generally comfortable atmosphere. This is also the time when the surrounding landscapes,*}
{*                                such as Halong Bay, are particularly beautiful.</p>*}
{*                            <p class="txt_p_detailblog">In March and April, it is spring in Hanoi. Temperatures*}
{*                                gradually*}
{*                                rise, making for pleasant days to explore the city. In addition, this period corresponds*}
{*                                to*}
{*                                the blossoming of cherry trees and the traditional festival of Tet (Vietnamese New*}
{*                                Year),*}
{*                                offering a festive and colorful atmosphere.</p>*}
{*                            <div class="img-blogdetail">*}
{*                                <img class="img_blogdetail" src="{URL_IMAGES}/blog/img_detailblog2.png" alt="imgdetail"*}
{*                                     title="imgdetail" width="908" height="605">*}
{*                            </div>*}
{*                            <p class="txt_p_detailblog">However, it is important to note that the climate can be*}
{*                                unpredictable in this region and there may be variations from year to year. It is*}
{*                                recommended to check the weather forecast before your trip and pack clothing suitable*}
{*                                for*}
{*                                varying temperatures. By avoiding the summer months (June to August) which can be hot*}
{*                                and*}
{*                                humid, as well as the winter months (December to February) which can be cool and foggy,*}
{*                                you*}
{*                                will be able to make the most of your visit to Hanoi.</p>*}
{*                        </div>*}

{*                        <div class="introduct_txt">*}
{*                            <h2 class="title-detailblog">Tops best things to do in Hanoi for 3 days</h2>*}
{*                            <p class="txt_p_detailblog">If you have three days to explore Hanoi, here's a suggested*}
{*                                itinerary to help you make the most of your trip:</p>*}
...
{*                            <div class="img-blogdetail">*}
{*                                <img class="img_blogdetail" src="{URL_IMAGES}/blog/img_detailblog3.png" alt="imgdetail"*}
{*                                     title="imgdetail" width="908" height="605">*}
{*                            </div>*}
{*                            <p class="txt_p_detailblog">Start your day by visiting Hoan Kiem Lake, a popular spot for*}
{*                                locals*}
{*                                and tourists alike. Hoan Kiem Lake, also known as Sword Lake, is a freshwater lake in*}
{*                                the*}
{*                                heart of Hanoi, which is one of the most popular tourist destinations in Hanoi, and it*}
{*                                is*}
{*                                also a sacred place for many Vietnamese people. The lake is based on the legend of*}
{*                                Vietnam*}
{*                                when King Le Loi was given a magical sword by the Golden Turtle God to help defeat the*}
{*                                Chinese invaders. After the victory, he returned the sword to the lake, and it is said*}
{*                                that*}
{*                                the Golden Turtle God still guards the sword today. This is a wonderful and peaceful*}
{*                                place*}
{*                                to visit, a great place to relax and enjoy the beauty of the scenery, and is also a*}
{*                                popular*}
{*                                space for locals and tourists to go for a walk, run, or bike ride…... Don’t forget to*}
{*                                visit*}
{*                                Ngoc Son temple, located on Jade Islet in the middle of Hoan Kiem Lake, this magnificent*}
{*                                temple is a historical and cultural treasure that attracts visitors from all over the*}
{*                                world.</p>*}
{*                            <p class="txt_p_detailblog">Start your day by visiting Hoan Kiem Lake, a popular spot for*}
{*                                locals*}
{*                                and tourists alike. Hoan Kiem Lake, also known as Sword Lake, is a freshwater lake in*}
                ...
                <div class="list_search_filter">
                    ...
                    <div class="featured-blogs">
                        ...
                        <div class="row featured-blog">
                            <div class="col-lg-4">
                                <a href="{$clsBlog->getLink($lstFeatureBlog[i].blog_id)}"><img class="img_featureblog" src="{$lstFeatureBlog[i].image}"
                                                 alt="featured-blog"/></a>
                            </div>
...
<!--
                        <div class="row featured-blog">
                            <div class="col-lg-4">
                                <a href="#"><img class="img_featureblog" src="{URL_IMAGES}/blog/pic_featureblog2.png"
                                                 alt="featured-blog"/></a>
                            </div>
                            <h3 class="col-lg-8 mt-log-0 txt_featuredblogs">
                        ...
                        <div class="row featured-blog">
                            <div class="col-lg-4">
                                <a href="#"><img class="img_featureblog" src="{URL_IMAGES}/blog/pic_featureblog3.png"
                                                 alt="featured-blog"/></a>
                            </div>
                            <h3 class="col-lg-8 mt-log-0 txt_featuredblogs">
                                <a href="#">Ninh Binh Day Tour (Hoa Lu- Tam Coc- Mua cave) - Review</a></h3>
        ...
        <div class="pic_textread row">
            <div class="col-md-7">
                <a href="#" alt="explore" title="explore">
                    <img class="pic_read img-fluid" src="{$URL_IMAGES}/blog/img_readthenext1.png" alt="pic_txt1"
