...
{if $mod ne 'cart'}
    {if $act ne 'success'}
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-5 border-top">
                                <div class="d-flex flex-nowrap align-items-center">
                                    <div class="img_logohn">
                                        <a href="/" title="logohn">
                                            <img title="logohanoi" src="{$clsConfiguration->getValue('FooterLogo')}"
                                                 alt="img-hanoi">
                                        </a>
                                    </div>
                                    ...
                                    <div class="d-flex icon-mxh" style="gap: 32px">
                                        {if $clsConfiguration->getValue('Youtube_Link')}
                                            <a class="link-secondary"
                                               href="https://www.youtube.com/{$clsConfiguration->getValue('SiteYoutubeLink')}">
                                                <i class="fa-brands fa-youtube fa-xl"></i>
                                            </a>
                                        {/if}
                                        {if $clsConfiguration->getValue('Twitter_Link')}
                                            <a class="link-secondary"
                                               href="https://x.com/{$clsConfiguration->getValue('SiteTwitterLink')}">
                                                <i class="fa-brands fa-x-twitter"></i>
                                            </a>
                                        {/if}
                                        {if $clsConfiguration->getValue('Instagram_Link')}
                                            <a class="link-secondary"
                                               href="https://www.instagram.com/{$clsConfiguration->getValue('SiteInstagramLink')}">
                                                <i class="fa-brands fa-instagram fa-xl"></i>
                                            </a>
                                        {/if}
                                        {if $clsConfiguration->getValue('Facebook_Link')}
                                            <a class="link-secondary"
                                               href="https://www.facebook.com/{$clsConfiguration->getValue('SiteFacebookLink')}">
                                                <i class="fa-brands fa-facebook-f"></i>
                                            </a>
                                        {/if}
                                        {if $clsConfiguration->getValue('Printest_Link')}
                                            <a class="link-secondary"
                                               href="https://www.pinterest.com/{$clsConfiguration->getValue('SitePrintestLink')}">
                                                <i class="fa-brands fa-pinterest"></i>
                                            </a>
                                        {/if}
                                        {if $clsConfiguration->getValue('LinkedIn_Link')}
                                            <a class="link-secondary"
                                               href="https://www.linkedin.com/{$clsConfiguration->getValue('SiteLinkedInLink')}">
        ...
        <div id="btn-tailor-fixed"><a href="#" class="tailor_btn_fixed" title="TAILOR-MADE TRAVEL">
                <div class="tailor_img_fixed"><img
                            src="https://unikasia.vietiso.com/isocms/templates/default/skin/images/destination/hn_voyages.png"
                            alt=""></div>
                TAILOR-MADE TRAVEL
            </a></div>
        ...
        <div id="icon-fixed">
            <div class="social-icons">
                {if $clsConfiguration->getValue('Youtube_Link')}
                    <a href="https://www.youtube.com/{$clsConfiguration->getValue('SiteYoutubeLink')}"
                ...
                {/if}
                {if $clsConfiguration->getValue('Instagram_Link')}
                    <a href="https://www.instagram.com/{$clsConfiguration->getValue('SiteInstagramLink')}"
                       class="social-icon"><i class="fa-brands fa-instagram"></i></a>
                {/if}
                {if $clsConfiguration->getValue('Facebook_Link')}
                    <a href="https://www.facebook.com/{$clsConfiguration->getValue('SiteFacebookLink')}"
                       class="social-icon"> <i class="fa-brands fa-facebook-f"></i> </a>
                {/if}
                {if $clsConfiguration->getValue('Printest_Link')}
                    <a href="https://www.pinterest.com/{$clsConfiguration->getValue('SitePrintestLink')}"
                       class="social-icon"> <i class="fa-brands fa-pinterest"></i></a>
                {/if}
                {if $clsConfiguration->getValue('LinkedIn_Link')}
                    <a href="https://www.linkedin.com/{$clsConfiguration->getValue('SiteLinkedInLink')}"
