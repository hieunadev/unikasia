...
if(isset($_POST['submit'])){
	...
	***/
    ...
    $on_domain = '';
	if(isset($_GET['on_domain']) && !empty($_GET['on_domain'])) {
		$on_domain = $_GET['on_domain'];
	}
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <ul class="breadcrumb">
                ...
                ?>
                <li class="pull-right">
                	<a id="refresh" href="dialog.php?type=<?php echo $_GET['type']?>&editor=<?php echo $_GET['editor'] ? $_GET['editor'] : 'mce_0'; ?>&on_domain=<?php echo $on_domain ?>&subfolder=<?php echo $subfolder ?>&popup=<?php echo $popup;?>&field_id=<?php echo $_GET['field_id'] ? $_GET['field_id'] : '';?>&lang=<?php echo $_GET['lang'] ? $_GET['lang'] : 'en_EN'; ?>&fldr=<?php echo $subdir ?>&<?php echo uniqid() ?>"><i class="icon-refresh"></i></a>
                </li>
            </ul>
        </div>
    	<!----- breadcrumb div end ------->
            ...
            <?php
                ...
                foreach ($files as $file) {
                    if (is_dir($root . $cur_dir . $file) && ($file != '.' && !($file == '..' && $subdir=='')) ) {
                        ...
                        <li>
                            <figure>
                                <a title="<?php echo lang_Open ?>" href="dialog.php?type=<?php echo $_GET['type']?>&subfolder=<?php echo $subfolder ?>&on_domain=<?php echo $on_domain ?>&editor=<?php echo $_GET['editor'] ? $_GET['editor'] : 'mce_0'; ?>&popup=<?php echo $popup;?>&field_id=<?php echo ((isset($_GET['field_id']) && !empty($_GET['field_id'])) ? $_GET['field_id'] : '');?>&lang=<?php echo $_GET['lang'] ? $_GET['lang'] : 'en_EN'; ?>&fldr=<?php echo $src ?>&<?php echo uniqid() ?>">
                                    <?php if($file==".."){ ?>
