            ...
            <form action="" class="simple_form new_review" enctype="multipart/form-data" id="frmCommentCrx" method="post">
                <div class="rating_block">
                    <div class="rating-body">
                        <div class="rate">
                            <span class="title">{$core->get_Lang('Your rating is here')}:</span><div class="rate_row"></div>
                        </div>
                        <div class="details">
                            <div class="control-group text optional mt10">
                                <div class="controls mb10">
                                    <input class="required form-control" name="fullname" id="fullname" value="" maxlength="255" type="text" placeholder="{$core->get_Lang('* Full Name')}"/>
                                </div>
                                <div class="controls mb10">
                                    <input class="email form-control" name="title" id="title" maxlength="255" type="text" placeholder="{$core->get_Lang('* Title of review')}"/>
                                </div>
                                <div class="controls mb10">
                                    <textarea class="form-control" name="message" id="message" minlength="100" placeholder="Comment"></textarea>
                                </div>
                                <div class="controls mb10">
