            ...
            <div class="fill_data_box">
                ...
                <div class="form-group inpt_tour">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-5">
                            <img class="img-responsive radius-3" id="isoman_show_map_tour" src="{$clsTour->getMapTour($oneItem.tour_id,80,59)}" onerror="this.src='{$URL_IMAGES}/none_image.png'" alt="{$core->get_Lang('images')}" style="width:450px; height:285px"  />
                        </div>
                    </div>
                </div>
            </div>
