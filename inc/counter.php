...
function online()
{
    ...
    $count = 1;
    $maxu = 1;
    $file1 = DIR_INCLUDES.'/counter/online.log';
    $lines = file($file1);
    $line2 = "";
...
///////////////////////
    ...
    $file_ip = fopen(DIR_INCLUDES.'/counter/ip.txt', 'rb');
    ...
    if (!($found==1)) {
        $file_ip2 = fopen(DIR_INCLUDES.'/counter/ip.txt', 'ab');
        $line = "$ip\n";
        fwrite($file_ip2, $line, strlen($line));
        $file_count = fopen(DIR_INCLUDES.'/counter/count.txt', 'rb');
        $data = '';
        ...
        $file_count2 = fopen(DIR_INCLUDES.'/counter/count.txt', 'wb');
