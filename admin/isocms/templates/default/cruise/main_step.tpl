            ...
            <div class="col-xs-12 col-sm-12 {if $currentstep eq ''}col-md-12{else}col-md-9{/if}">
                <div class="fill_data_box">
                    <div class="form_title_and_table_code" {$currentstep}>
                        ...
                        <div class="inpt_tour">
                            <textarea style="width:100%" table_id="{$pvalTable}" name="iso-inclusion" class="textarea_intro_editor_simple" data-column="iso-inclusion" id="textarea_intro_editor_overview_{$now}" cols="255" rows="2">{$oneItem.inclusion}</textarea>
                        </div>
                        ...
                        <div class="inpt_tour">
                            <textarea style="width:100%" table_id="{$pvalTable}" name="iso-exclusion" class="textarea_intro_editor_simple" data-column="iso-exclusion" id="textarea_intro_editor_overview_{$now}" cols="255" rows="2">{$oneItem.exclusion}</textarea>
                        </div>
