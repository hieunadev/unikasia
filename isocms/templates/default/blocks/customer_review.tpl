            ...
            {section name=i loop=$listReview}
                ...
                <div class="customer_card item">
                    ...
                    <div class="customer_review">
                        ...
                        <div class="content">{$clsISO->limit_textIso($listReview[i].intro|html_entity_decode, 30)} <a class="more_review" data-fancybox data-src="#modalViewMore{$k}" href="javascript:;">{$core->get_Lang('View more')}</a></div>
                        <div class="customer_avt">
                            <img src="{$listReview[i].avatar}" alt="avatar">
