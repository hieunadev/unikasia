<div class="des_travel_guide_side">
    ...
    ($mod eq 'guide' && $act eq 'cat') || ($mod eq 'guide' && $act eq 'search') || ($mod eq 'guide' && $act eq
    'detail')}
        ...
        <div class="des_travel_guide_tour_more_image">
            ...
            <div class="des_travel_guide_tour_more_title">
                ...
                <a href="{$clsTourCategory->getLink(0, '', '', $country_id)}"
                    title="See all tours in {$country_title}">See all tours <i class="fa-light fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
    {elseif $mod eq 'destination' && $act eq 'attraction'}
            ...
            <div class="des_travel_guide_most_read_item">
                <div class="row">
                    <div class="col-4 col-sm-3 col-md-12 col-lg-4">
                        <img src="https://images.unsplash.com/photo-1715522196138-1da0d3669bc5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDl8RnpvM3p1T0hONnd8fGVufDB8fHx8fA%3D%3D"
                            width="83" height="83" alt="Vietnam Airlines Launches New Routes To Singapore, Cambodia">
                    </div>
