tinymce.PluginManager.add("link_on_domain", function(e) {
    function openmanager() {
        ...
        win = e.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=2&on_domain=1&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
            filetype: 'file',
            width: 900,
            height: 600,
            inline: 1
