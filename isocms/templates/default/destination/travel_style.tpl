<section class="page_container trvs_page_container">
    <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
        <div class="container d-flex">
            ...
            <ol class="breadcrumb des_breadcrumb">
                ...
                <li class="breadcrumb-item des_breadcrumb_link"><a href="#" title="Destinations">Vietnam</a></li>
                <li class="breadcrumb-item des_breadcrumb_link"><a href="#" title="Destinations">Vietnam tours</a></li>
