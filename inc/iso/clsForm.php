...
class Form{
	...
	function showInputTextAreaTinyMCPuk($input){
		...
		$html .= "\n";				
		$html .= '<script type="text/javascript">function submitFormEditor(){$("form button[type=submit]").click();event.preventDefault();return false;} ';				
		switch($type) {
			case "simple"      : $html .= _TINYMCE_CONFIG_SIMPLE;
							   break;
			case "full"      : $html .= _TINYMCE_CONFIG;
							   break;
		}
