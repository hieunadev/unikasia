...
//error_reporting(E_ALL);
	...
	$pvalTable =Input::get('guide_id',0);$assign_list["pvalTable"] = $pvalTable;
...
//error_reporting(E_ALL);
	...
	$pvalTable =Input::get('guidecat_id',0);$assign_list["pvalTable"] = $pvalTable;
	$panel =Input::get('panel','');$assign_list["panel"] = $panel;
...
function default_insert2() {
	...
	$pvalTable =Input::get('guide2_id',0);$assign_list["pvalTable"] = $pvalTable;
	$panel =Input::get('panel','');$assign_list["panel"] = $panel;
...
//error_reporting(E_ALL);
	...
	$clsRegion = new Region(); $smarty->assign('clsRegion', $clsRegion);
	$clsCity = new City(); $smarty->assign('clsCity', $clsCity);
	$clsGuideCat = new GuideCat(); $smarty->assign('clsGuideCat', $clsGuideCat);
	$clsGuide2 = new Guide2(); $smarty->assign('clsGuide2', $clsGuide2);
