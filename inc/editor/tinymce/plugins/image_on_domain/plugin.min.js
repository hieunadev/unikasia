tinymce.PluginManager.add("image_on_domain", function(e) {
    function openmanager() {
        ...
        win = e.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=1&on_domain=1&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
            filetype: 'image',
            width: 900,
            height: 600,
            inline: 1
