											...
											<tbody id="SortAble">
												...
												<tr style="cursor:move" class="{cycle values="row1,row2"}" id="order_{$listCruiseItinerary[i].cruise_itinerary_id}">
													<td class="text-left name_service">
														<div class="box_name_services"> 
															<p class="txt_name_services">
															<a title="{$core->get_Lang('edit')}" href="javascript:void()" class="edit_itinerary" data-cruise_itinerary_id="{$listCruiseItinerary[i].cruise_itinerary_id}" data-cruise_id="{$pvalTable}"><strong style="font-size:15px;">{$clsCruiseItinerary->getDuration($listCruiseItinerary[i].cruise_itinerary_id)}</strong></a></p> 
															<p class="txt_info">
