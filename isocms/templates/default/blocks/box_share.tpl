...
<style type="text/css">
	...
	.share_news .sharer-icons a.sharer-icon-youtube { color: #1385c4; border-color: #89c6e7; } 
	.share_news .sharer-icons a.sharer-icon-youtube:hover { background: #1385c4; color:#FFF }
	
	.share_news .sharer-icons a.sharer-icon-instagram { color: #1385c4; border-color: #89c6e7; }
	.share_news .sharer-icons a.sharer-icon-instagram:hover { background: #1385c4; color:#FFF }
