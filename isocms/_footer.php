...
global $assign_list,$smarty, $core, $dbconn, $mod, $act, $_LANG_ID, $title_page, $description_page, $global_image_page,
$global_title_page, $global_description_page, $global_image_seo_page, $clsISO, $clsConfiguration,$package_id;
