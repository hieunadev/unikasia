...
//				echo(PCMS_URL.'/index.php?mod='.$mod.'&act=edit&'.$clsCruise->pkey.'='.$core->encryptID($max_id));die();
				echo PCMS_URL.'/cruise/insert/'.$max_id.'/overview/basic';die();
			}else{
				echo '_ERROR'; die();
			}		
		}
...
function default_ajOpenManageCabinPriceCruiseOld(){
	...
	if($tp=='L'){
        ...
        print_r($price);die('xxxx');
		
		$res = $clsCruiseSeasonPrice->getAll("cruise_itinerary_id='$cruise_itinerary_id' and cruise_cabin_id='$cruise_cabin_id' and group_size_id='$group_size_id' and season='$season'");
        
        print_r($res);die('xxxx');
...
error_reporting(E_ALL);*/
	...
	if($tp=='L'){
		$priceByLow = $clsCruiseItinerary->getOneField("price_by_low",$cruise_itinerary_id); $assign_list['priceByLow'] = $priceByLow;
		$priceByHigh = $clsCruiseItinerary->getOneField("price_by_high",$cruise_itinerary_id); $assign_list['priceByHigh'] = $priceByHigh;
