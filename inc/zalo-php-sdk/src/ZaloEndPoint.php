...
class ZaloEndPoint
{
     ...
     * @const
     */
    const API_SEND_ZNS = 'https://business.openapi.zalo.me/message/template';
    
    /**
     * @const
     */
    const API_OA_QUOTA = 'https://business.openapi.zalo.me/message/quota';
    
    /**
     * @const
     */
    const API_OA_SEND_MESSAGE = 'https://openapi.zalo.me/v3.0/oa/message/cs';
